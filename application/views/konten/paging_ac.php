<div id="page-wrapper">
  ...
  <div class="row">
      ...
      <br>
      <?php
        $sql ="SELECT * FROM sys_sinkronisasi";
          ...
          <div class="panel panel-primary">
              ...
              <!-- end tab -->
                <!-- <div class="row"> -->
                    ...
                    <div class="col-lg-4">
                    <input type="submit" value="Cari" class="btn btn-warning col-md-3">
                    </div>
                    <?php echo form_close();?>	
                <!-- </div> -->
                <br>
                  ...
                  <table width="100%" class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                          ...
                          <tr class="odd gradeX">
                              ...
                              <td><?php $faktor =  $row->faktor_perceraian_id; 
                                        if($faktor==1){
                                            echo "Zina";
                                        }else if($faktor==2){
                                            echo "Mabuk";
                              ...
                              <td>
                                  <center>
                                    <div class="tooltip-demo">
                                      <a href='<?php echo base_url()?>ac/detil/<?=$row->perkara_id;?>' class="btn btn-success btn-circle " > Detil </a>
                                    </div>
                                  </center>
                              </td>
                          </tr>
