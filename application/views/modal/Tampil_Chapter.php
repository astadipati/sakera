      ...
      <div class="col-lg-12">
          ...
          <div class="panel panel-primary">
              <div class="panel-heading">
                  <i class="fa fa-table"></i> Data Chapter
              </div>
              <!-- /.panel-heading -->
                  ...
                  <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                      ...
                      <tbody>
                          ...
                          <tr class="odd gradeX">
                              ...
                              <td><?php echo $row->chapter_ke; ?></td>
                              <td><?php echo $row->gambar; ?></td>
                              <td><?php echo $row->judul_chapter; ?></td>
                              <td><?php echo $row->tanggal_posting; ?></td>
                              <td>
                                  <center>
                                    <div class="tooltip-demo">
                                      <a data-toggle="modal" data-target="#tambah-detil-chapter<?=$row->chapter_id;?>" class="btn btn-success btn-circle" data-popup="tooltip" data-placement="top" title="Tambah Detil Chapter"><i class="fa fa-plus"></i></a>
                                      <a data-toggle="modal" data-target="#modal-edit<?=$row->chapter_id;?>" class="btn btn-warning btn-circle" data-popup="tooltip" data-placement="top" title="Edit Chapter"><i class="fa fa-pencil"></i></a>
                                      <!-- <a href="<?php echo site_url('data/hapus/'.$row->chapter_id); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?=$row->chapter_id;?> ?');" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Hapus Komik"><i class="fa fa-trash"></i></a> -->
                                    </div>
                                  </center>
                              </td>
                          </tr>
...
<div class="row">
  <div id="tambah-detil-chapter<?=$row->chapter_id;?>" class="modal fade">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header bg-primary">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          ...
          ?>
            <div class="form-group">
                <div class="col-sm-12">
                  ...
                  <input type="text" readonly value="<?=$row->chapter_id;?>" name="chapter_id" class="form-control" >
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
...
foreach($all as $row): $no++; ?>
<div class="row">
  <div id="modal-edit<?=$row->chapter_id;?>" class="modal fade">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header bg-primary">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
