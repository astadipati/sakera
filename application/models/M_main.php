...
class M_main extends CI_Model {
    ...
    function report(){
        $query = $this->db->query("SELECT * from v_total_perceraian");
    ...
    function updated(){
        $update = $this->db->query("SELECT * FROM sys_sinkronisasi");
	...
	// end 
	function dashboard(){
		$dash = $this->db->query("SELECT * FROM db_master.v_grafik;");

// function dashboard(){
	// 	$dash = $this->db->query("SELECT MONTH(tgl_akta_cerai) tanggal,
